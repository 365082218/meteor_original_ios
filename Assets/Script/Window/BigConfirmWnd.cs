...
public class BigConfirmWnd <T>  where T:class,new (){
    public string PrefabName { get { return "BigConfirmWnd"; } }
    ...
    void Init()
    {
        ...
        mConfirmPanel = ldaControl("ConfirmPanel");
    ...
    public void SetParentWnd(Window<T> pWnd, int confirmTag, string centerTips, string confirmbtn = "", string cancleBtn = "", string title = "", GameObject ConfirmPanel= null)
    {
        mParentWnd = pWnd;
        ...
        if (ConfirmPanel != null)
        {
           ...
           // ConfirmPanel.transform.parent = mConfirmPanel.transform;
