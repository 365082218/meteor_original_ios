	...
	public void ShowHierarchyObjectPopup(string scriptFilename, Object selObj)
	{
		if (scriptFilename != null)
		{
			...
			if (m_CurrentHierarchyPopup == null)
				m_CurrentHierarchyPopup	= UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(m_ToolPopupGameObject, "Assets/Effect/Package/IGSoft_Tools/FXMaker/ToolScript/ToolScript/FxmPopupManager.cs (418,31)", scriptFilename) as FxmPopup;
			if (m_CurrentHierarchyPopup != null)
