...
//			Debug.Log("position:"+mHighlight.transform.localPosition);
			...
			for (int i = 0, imax = items.Count; i < imax; ++i)
			{
				...
				lbl.color = textColor;
				lbl.cachedTransform.localPosition = new Vector3(bgPadding.x + padding.x, y, -1.0f);
