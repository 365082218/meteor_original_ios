...
public class UIFont : MonoBehaviour
{
    ...
    {
        if (font.UseDynamicFont && !_fontList.Contains(font.dynamicFont_1))
        {
            _fontList.Add(font.dynamicFont_1);
            font.dynamicFont_1.textureRebuildCallback += OnFontRebuilt;
        }
    }
    ...
    //Lindean - ADDITIONAL FIELDS FOR DYNAMIC FONTS
    public Font dynamicFont_1;
    public Material dynamicFontMaterial_1;
    public int dynamicFontSize_1 = 12;
    public FontStyle dynamicFontStyle_1;

    public bool UseDynamicFont { get { return (dynamicFont_1 != null); } }
    ...
    int charSize
    {
        get
        {
            return (UseDynamicFont ? dynamicFontSize_1 : mFont.charSize);
        }
    }
    //Lindean
	...
	public Material material
	{
		get
		{
            ...
            if (UseDynamicFont)
            {
                if (dynamicFontMaterial_1 != null)
                {
                    dynamicFontMaterial_1.mainTexture = dynamicFont_1.material.mainTexture;
                    return dynamicFontMaterial_1;

                }
                return dynamicFont_1.material;
            }
	...
	public Font dynamicFont
	{
		get
		{
			return (mReplacement != null) ? mReplacement.dynamicFont_1 : mDynamicFont;
		}
		set
		{
			if (mReplacement != null)
			{
				mReplacement.dynamicFont_1 = value;
			}
	...
	public int dynamicFontSize
	{
		get
		{
			return (mReplacement != null) ? mReplacement.dynamicFontSize_1 : mDynamicFontSize;
		}
		set
		{
			if (mReplacement != null)
			{
				mReplacement.dynamicFontSize_1 = value;
			}
			else
			{
	...
	public FontStyle dynamicFontStyle
	{
		get
		{
			return (mReplacement != null) ? mReplacement.dynamicFontStyle_1 : mDynamicFontStyle;
		}
		set
		{
			if (mReplacement != null)
			{
				mReplacement.dynamicFontStyle_1 = value;
			}
