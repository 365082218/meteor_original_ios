...
Shader "Custom/BossShader" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _ill; uniform float4 _ill_ST;
            uniform float4 _kcolor;
...
////// Specular:
                ...
                float4 _ill_var = tex2D(_ill,TRANSFORM_TEX(i.uv0, _ill));
...
// rim color 
             ...
             //  float rimColor=_kcolor.rgb * pow (rim, 1);
               float rimColor=_kcolor.rgb *rim;
/// Final Color:
