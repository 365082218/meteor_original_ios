...
public class Lua_UnityEngine_ParticleSystemRenderer : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int AreVertexStreamsEnabled(IntPtr l) {
		try {
			UnityEngine.ParticleSystemRenderer self=(UnityEngine.ParticleSystemRenderer)checkSelf(l);
			UnityEngine.ParticleSystemVertexStreams a1;
			checkEnum(l,2,out a1);
			var ret=self.AreVertexStreamsEnabled(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetEnabledVertexStreams(IntPtr l) {
		try {
			UnityEngine.ParticleSystemRenderer self=(UnityEngine.ParticleSystemRenderer)checkSelf(l);
			UnityEngine.ParticleSystemVertexStreams a1;
			checkEnum(l,2,out a1);
			var ret=self.GetEnabledVertexStreams(a1);
			pushValue(l,true);
			pushEnum(l,(int)ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,EnableVertexStreams);
		addMember(l,DisableVertexStreams);
		addMember(l,AreVertexStreamsEnabled);
		addMember(l,GetEnabledVertexStreams);
