...
namespace Outfit7.Sequencer {
    [SequencerQuickSearchAttribute("lpos")]
    [SequencerQuickSearchDisplayAttribute("Local Position")]
    [SequencerPropertyAttribute("Transform/Local Position")]
    public class LocalPositionPropertyView : BasePropertyView {
