...
namespace Outfit7.Sequencer {
    [SequencerQuickSearchAttribute("wpos")]
    [SequencerQuickSearchDisplayAttribute("World Position")]
    [SequencerPropertyAttribute("Transform/World Position")]
    public class WorldPositionPropertyView : BasePropertyView {
