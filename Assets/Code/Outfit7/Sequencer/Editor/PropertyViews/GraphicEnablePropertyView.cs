...
namespace Outfit7.Sequencer {
    ...
    [SequencerQuickSearchDisplayAttribute("Graphic Enabled")]
    [SequencerPropertyAttribute("UI/Graphic Enabled")]
    public class GraphicEnablePropertyView : BasePropertyView {
