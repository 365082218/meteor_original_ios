...
namespace Outfit7.Sequencer {
    [SequencerQuickSearchAttribute("goto")]
    [SequencerQuickSearchDisplayAttribute("Go To")]
    [SequencerNormalTrackAttribute("Sequence/Go To")]
    public class SequencerGoToEventView : SequencerTriggerEventView {
        private SequencerGoToEvent Event = null;
        ...
        public override void OnInit(object evnt, object parent) {
            Event = evnt as SequencerGoToEvent;
        ...
        public override void OnDrawExtendedGui(Rect windowSize, float startHeight, float splitViewLeft, TimelineData timelineData, SequencerFoldoutData foldoutData, List<Parameter> parameters) {
            ...
            ParameterFieldView.DrawParameterField(GetRectPosition(40f, 40f, 40f), Event.GoToTime, parameters);
        }
