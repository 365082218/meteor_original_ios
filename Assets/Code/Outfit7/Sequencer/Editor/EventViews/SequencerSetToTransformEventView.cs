...
namespace Outfit7.Sequencer {
    [SequencerQuickSearchDisplayAttribute("Set To Transform")]
    [SequencerCurveTrackAttribute("Set/To Transform")]
    public class SequencerSetToTransformEventView : SequencerTriggerEventView {
        private SequencerSetToTransformEvent Event = null;
        ...
        public override void OnInit(object evnt, object parent) {
            Event = evnt as SequencerSetToTransformEvent;
