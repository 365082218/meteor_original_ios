...
{	
  ...
  var previewEx : SerializedProperty;
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    previewEx = serObj.FindProperty ("preview");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (previewEx, new GUIContent("Preview"));
    if (previewEx.boolValue)
