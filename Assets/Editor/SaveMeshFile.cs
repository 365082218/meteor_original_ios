            ...
            Object ian1633
{
  ...
  Custom:
  {
    ...
    [MenuItem("Meteor/Mesh/SaveMeshAsset")]
    static void SaveMeshAsset()
    {
        ...
        Mesh me = Selection.activeGameObject.GetComponent<MeshFilter>().mesh;
        AssetDatabase.CreateAsset(me, "Assets\\Models\\MapObject\\" + Selection.activeGameObject.name + ".asset");
