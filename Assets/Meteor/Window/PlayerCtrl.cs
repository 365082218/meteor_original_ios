...
public class PlayerCtrl : MonoBehaviour {
    ...
    //    texture.Apply();
    //    System.IO.File.WriteAllBytes(Application.persistentDataPath + "/" + GameData.Instance.gameStatus.saveSlot + "/" + current.idx + "_mask.png", texture.EncodeToPNG());
    //    RenderTexture.active = null;
    //}
    ...
    public void LoadMapInstance(int idx)
    {
       ...
       // if (!firstload && System.IO.File.Exists(Application.persistentDataPath + "/" + GameData.Instance.gameStatus.saveSlot + "/" + current.idx + "_mask.png")) 
       // {
       //     byte[] png = System.IO.File.ReadAllBytes(Application.persistentDataPath + "/" + GameData.Instance.gameStatus.saveSlot + "/" + current.idx + "_mask.png");
